...
/*
extract_label - returns the label without the parenthesis
param1 - line - the line to process
param2 - label - the string to insert the processed line
return - char* - the label without parenthesis 
*/
